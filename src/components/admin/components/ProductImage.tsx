...
const OptimizedProductImage: React.FC<ProductImageProps> = ({
  ...
  const imageUrl = useBase64 
    ? `http://179.43.118.101:4000/api/producto/${productId}/imagen-base64`
    : `http://179.43.118.101:4000/api/producto/${productId}/imagen?quality=${quality}&width=${width}&height=${height}&v=${timestamp}`;
